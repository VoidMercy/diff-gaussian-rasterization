...
class GaussianRasterizer(nn.Module):
    ...
    def forward(self, means3D, means2D, opacities, bvh_nodes, bvh_aabbs, aabbs, shs = None, colors_precomp = None, scales = None, rotations = None, cov3D_precomp = None):
